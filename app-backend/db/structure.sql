...
CREATE TABLE IF NOT EXISTS "transactions" ("id"  NOT NULL PRIMARY KEY, "account_id"  NOT NULL, "amount" integer DEFAULT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_01f020e267"
FOREIGN KEY ("account_id")
  REFERENCES "accounts" ("id")
);
